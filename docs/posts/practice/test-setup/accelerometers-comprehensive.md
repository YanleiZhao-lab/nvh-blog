...
*变速箱箱体上安装的加速度计，蓝线接入 Simcenter SCADAS 采集硬件完成模态试验（图源：网络 侵删）*
...
*加速度计规格书示例：灵敏度、量程与频响是三项核心选型参数（图源：网络 侵删）*
...
*三只传感器的频响对比：Sensor 3 平直段最宽（图源：网络 侵删）*
...
*加速度计的可用带宽：取平直段，高频端远离自身共振峰（图源：网络 侵删）*
...
*变电容加速度计：质量块连接可动电极（图源：网络 侵删）*

![图18](/images/accelerometers-comprehensive/fig18.png)

*基于变电容原理的 MEMS 设计（图源：网络 侵删）*
...
*各种安装方式对频响的影响：连接越刚，频带越宽（图源：网络 侵删）*

![图20](/images/accelerometers-comprehensive/fig20.png)

*斜切垫块用于曲面安装并保持全局坐标方向（图源：网络 侵删）*
...
*诺谟图：按电压、电流、电缆电容查最高可用频率（图源：网络 侵删）*
...
*Testlab Classic 通道设置速查（图源：网络 侵删）*

![图26](/images/accelerometers-comprehensive/fig26.png)

*Testlab Neo 的 Channels 页签（图源：网络 侵删）*
