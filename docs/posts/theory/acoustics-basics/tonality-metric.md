...
*图 1　纯音必须在背景之上足够突出才算可闻纯音：左图差距不足，右图差距足够（图源：网络 侵删）*
...
*式 1　Aures/Terhardt 音调度公式（图源：网络 侵删）*
...
*图 3　经典音调度输出纯音能量占比式的 0~1 读数（图源：网络 侵删）*
...
*图 9　心理声学音调度可按临界带给出频率分布，经典方法无此能力（图源：网络 侵删）*
...
*图 4　t.u.HMS 反映纯音的绝对可感知强度而非能量占比（图源：网络 侵删）*
